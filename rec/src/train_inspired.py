...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default='./checkpoint/train-seed42-inspired', help="Where to store the final model.")
    ...
    parser.add_argument("--prompt_encoder", type=str, default="./checkpoint/pretrain-seed42-inspired/best")
    # optim
...
if __name__ == '__main__':
    ...
    item_comment = item_comment(dataset = 'inspired', model_name_or_path=(args.text_encoder or args.text_tokenizer))
