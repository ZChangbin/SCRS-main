...
def parse_args():
    ...
    parser.add_argument("--quantile_threshold", type=float, default=0.3, help="the threshold of quantile")
    ...
    parser.add_argument("--check_point", type=str,default="./checkpoint/trained_inspired-seed42/best", help="path to the check point")
